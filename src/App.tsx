/* App.tsx — 랭킹보드 5열 고정 & 순위숫자 색상 엠블럼 글자색 적용 */
    ...
    <div className="wrap">
      ...
      {page === 5 && (
        <section className="box">
          ...
          {/* 5개 섹션(득점/도움/수비/팀/클린시트)이 한 행에 고정 */}
      ...
      <style>{`
        :root{
          --gold:#D4AF37;          /* 막대/강조용 금색 */
          --gold-2:#C89B3C;
          --emblem-word:#EAEAEA;   /* 골딘 엠블럼 글자색(필요시 여기만 바꾸면 됨) */
          --bg:#0B0C0F;
          --card:#15161A;
          --line:#23252B;
          --text:#EAEAEA;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (min-width: 1024px){ .ranking-grid { grid-template-columns: repeat(5, 1fr); } } /* ✅ 데스크톱 5열 고정 */

        .ranking-section { min-width: 0; } /* 줄바꿈 방지용 수축 허용 */
        .ranking-section h4 { margin: 6px 0 8px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }

        /* 랭킹 카드(각 섹션 내부의 개별 항목 표시) */
        ...
        .rank-card .player-name {
          flex:1 1 auto; margin:0 4px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis; font-size:14px;
        }
        .rank-card .player-score { font-weight:800; color:var(--gold); font-size:14px; line-height:1; } /* 점수 = 금색 유지 */
