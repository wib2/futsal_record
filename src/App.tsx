 ...
 * - 선수별 G/A 입력: 0~9 드롭다운
 * - 팀 득점(H/A): 0~9 드롭다운
 * - 팀 선택 라벨: 사용자가 입력한 팀명 표시
 * - 팀 변경 시, 해당 팀에 GK가 1명일 경우 자동선택 유지
 * - 경기 추가: 4·7=1경기, 5·8=2경기, 6·9=3경기 자동 매칭(수정 가능)
 * - 선수 관리: 이름 입력칸 너비 절반으로 축소
 */
...
function normalizeLoaded(data: any): PersistShape {
  const today = ensureSunday(toISO(new Date())); // ← 괄호 수정됨
