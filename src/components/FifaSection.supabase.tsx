...
async function upsertFifa(row: Row): Promise<boolean> {
  ...
  // try upsert with onConflict if available; otherwise manual
...
// --- Optional: project images discovery (works when assets are in src/assets) ---
    ...
    <section className="box">
      ...
      <div className="row" style={{ gap: 24, alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div className="grid" style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: "8px 12px", minWidth: 260 }}>
          ...
          {/* Optional project images picker (if discovered) */}
          {foundImages.length > 0 && <>
            <label>프로젝트 이미지 선택</label>
